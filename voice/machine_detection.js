...
app.all('/machine_detection/', function(request, response) {
    ...
    var from_number = request.params('From'); // The From number which is used to make the call.
    var machine = request.params('Machine'); // This parameter will be true if a machine has been detected on the call.
    var to_number = request.params('To'); // The number which is being called.
    var call_uuid = request.params('CallUUID'); // The ID of the call.
    var events = request.params('Event'); // The event of the notification. This parameter will always have the value MachineDetection.
    var call_status = request.params('CallStatus'); // The status of the call. This will hold the value of in-progress.
...
app.all('/detect/', function(request, resp) {
    ...
    response.addSpeak("Hello Voicemail!");
